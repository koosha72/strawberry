...
namespace Strawberry.Math
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        public static void Transform(Vector3[] sourceArray, int sourceIndex, ref Matrix4 matrix,
        ...
        public static void TransformNormal(Vector3[] sourceArray, int sourceIndex, ref Matrix4 matrix,
                                           Vector3[] destinationArray, int destinationIndex, int length)
        {
            throw new NotImplementedException();
        }
