...
namespace Strawberry.Math
{
    ...
    public struct Matrix4 : IEquatable<Matrix4>
    {
        ...
        public static Matrix4 CreateOrthographic(float left, float right, float bottom,
            float top, float near, float far)
        {
            Vector4 last = new Vector4();
            last.X = -((right + left) / (right - left));
            last.Y = -((top + bottom) / (top - bottom));
            last.Z = ((far + near) / (far - near));
            last.W = 1;
            return new Matrix4(
                2 / (right - left), 0, 0, 0,
                0, 2 / (top - bottom), 0, 0,
                0, 0, -2 / (far - near), 0, last.X, last.Y, last.Z, last.W);
        }
        ...
        public static Matrix4 CreatePerspective(float width, float height, float zNearPlane, float zFarPlane)
        {
            throw new NotImplementedException();
        }
        ...
        public static void CreatePerspectiveFieldOfView(float fieldOfView, float aspectRatio, float nearPlaneDistance,
                                                        float farPlaneDistance, out Matrix4 result)
        {
            ...
            float yscale = (float)1 / (float)System.Math.Tan(fieldOfView / 2);
        ...
        public static Matrix4 CreatePerspectiveOffCenter(float left, float right, float bottom, float top,
                                                        float zNearPlane, float zFarPlane)
        {
            throw new NotImplementedException();
        }
        ...
        public static void CreatePerspectiveOffCenter(float left, float right, float bottom, float top,
                                                      float nearPlaneDistance, float farPlaneDistance, out Matrix4 result)
        {
            throw new NotImplementedException();
        }
        ...
        public static Matrix4 CreateRotationX(float radians)
        {
            ...
            returnMatrix.M22 = (float)System.Math.Cos(radians);
            returnMatrix.M23 = (float)System.Math.Sin(radians);
        ...
        public static void CreateRotationX(float radians, out Matrix4 result)
        {
            ...
            result.M22 = (float)System.Math.Cos(radians);
            result.M23 = (float)System.Math.Sin(radians);
        ...
        public static Matrix4 CreateRotationY(float radians)
        {
            ...
            returnMatrix.M11 = (float)System.Math.Cos(radians);
            returnMatrix.M13 = (float)System.Math.Sin(radians);
        ...
        public static void CreateRotationY(float radians, out Matrix4 result)
        {
            ...
            result.M11 = (float)System.Math.Cos(radians);
            result.M13 = (float)System.Math.Sin(radians);
        ...
        public static Matrix4 CreateRotationZ(float radians)
        {
            ...
            returnMatrix.M11 = (float)System.Math.Cos(radians);
            returnMatrix.M12 = (float)System.Math.Sin(radians);
        ...
        public static void CreateRotationZ(float radians, out Matrix4 result)
        {
            ...
            result.M11 = (float)System.Math.Cos(radians);
            result.M12 = (float)System.Math.Sin(radians);
        ...
        {
            Matrix4 inverse = Invert(matrix2);
        ...
        public static void Invert(ref Matrix4 matrix, out Matrix4 result)
        {
            ...
            Matrix4 ret; // Allow for matrix and result to point to the same structure
        ...
        public static Matrix4 operator /(Matrix4 matrix1, float divider)
        {
            Matrix4 ret;
            Divide(ref matrix1, divider, out ret);
            return ret;
        ...
        public static Matrix4 operator *(float scaleFactor, Matrix4 matrix)
        {
            Matrix4 target;
